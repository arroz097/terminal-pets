...
print("animal commands: forage, eat [food name], sleep, stats, map, logs [page], inventory [flag], move [region name], discard [item name]\n")
print("debug commands.: properties, drainHunger\n")
